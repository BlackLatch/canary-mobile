// DossierV3 contract configuration and ABI
// Contract deployed on Status Network Sepolia with Guardian support
...
export const DOSSIER_ABI = [
  ...
  },
  {
    ...
    "name": "GuardianRevokedConfirmation",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  {
    "inputs": [],
    "name": "MAX_GUARDIANS_PER_DOSSIER",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "uint256",
        "name": "guardianConfirmationCount",
        "type": "uint256"
      }
    ],
    "stateMutability": "view",
    ...
    "outputs": [
      {
        ...
        "internalType": "struct CanaryDossierV3.Dossier",
        "name": "",
        "type": "tuple"
      }
    ],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct CanaryDossierV3.DossierReference[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
  ...
  },
  {
    ...
    "name": "getDossiersWhereRecipient",
    "outputs": [
      {
        "components": [
          {
  ...
  },
  {
    ...
    "name": "getGuardianConfirmationCount",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
